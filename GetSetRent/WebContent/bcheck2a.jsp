...
<div class="do" >
  <img class="mySlides" src="images/bd9.jpg" >
  <img class="mySlides" src="images/image2.jpg" >
  <img class="mySlides" src="images/k3.jpg" >
...
<option value="P" />P </option></select><br><br>
    Location: <select name="location"><option  value="MasterCanteen" />Master Canteen</option></select>  <br><br>
  PPM: <select name="ppm"> <option value="Rs.17000" />Rs.17000</option></select><br><br>
