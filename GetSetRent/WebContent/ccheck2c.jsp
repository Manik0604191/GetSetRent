...
<div class="do" >
  <img class="mySlides" src="images/bd7.jpg" >
  <img class="mySlides" src="images/image2.jpg" >
  <img class="mySlides" src="images/k9.jpg" >
...
<option value="K" />K </option></select><br><br>
    Location: <select name="location"><option  value="Mangalabaag" />Mangalabaag</option></select>  <br><br>
