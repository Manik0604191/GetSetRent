...
<div class="do" >
  <img class="mySlides" src="images/bd8.jpg" >
...
<option value=" M" />M </option></select><br><br>
    Location: <select name="location"><option  value="College Square" />College Square</option></select>  <br><br>
  PPM: <select name="ppm"> <option value="Rs.18500" />Rs.18500</option></select><br><br>
