...
<option value="Z" />Z </option></select><br><br>
    Location: <select name="location"><option  value="Patia" />Patia</option></select>  <br><br>
  PPM: <select name="ppm"> <option value="Rs.18000" />Rs.17000</option></select><br><br>
