...
<div class="do" >
  <img class="mySlides" src="images/bd5.jpg" >
  <img class="mySlides" src="images/image2.jpg" >
  <img class="mySlides" src="images/k7.jpg" >
...
<option value="F" />F </option></select><br><br>
    Location: <select name="location"><option  value="KhanNagar" />Khan Nagar</option></select>  <br><br>
