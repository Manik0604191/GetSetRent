...
<div class="do" >
  <img class="mySlides" src="images/bd4.jpg" >
  <img class="mySlides" src="images/image2.jpg" >
  <img class="mySlides" src="images/k4.jpg" >
...
<option value="N" />N </option></select><br><br>
    Location: <select name="location"><option  value="Ranihaat" />Buxi Bazaar</option></select>  <br><br>
