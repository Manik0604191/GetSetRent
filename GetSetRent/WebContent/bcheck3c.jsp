...
<div class="do" >
  <img class="mySlides" src="images/bd3.jpg" >
  <img class="mySlides" src="images/image2.jpg" >
  <img class="mySlides" src="images/k5.jpg" >
...
<form action="regidpro.jsp">
  Enter your REGD ID:<input type="text" name="regid" value="" />  <br><br>
    Owner: <select name="owner">
<option value="P" />P </option></select><br><br>
    Location: <select name="location"><option  value="KalingaVihar" />Kalinga Vihar</option></select>  <br><br>
  PPM: <select name="ppm"> <option value="Rs.16500" />Rs.16500</option></select><br><br>
