...
<div class="do" >
  <img class="mySlides" src="images/bd2.jpg" >
  <img class="mySlides" src="images/image2.jpg" >
  <img class="mySlides" src="images/k2.jpg" >
...
<h2><u>Features</u></h2>
<p style="font-size:24px">Bed Facility : Yes <br>
Wifi : Yes <br>
Furnished : Yes <br>
...
<option value="Y" />Y </option></select><br><br>
    Location: <select name="location"><option  value="Khandagiri" />Khandagiri</option></select>  <br><br>
  PPM: <select name="ppm"> <option value="Rs.18000" />Rs.16500</option></select><br><br>
<input type="submit" value="BOOK NOW!" onclick="location.href='payment.jsp';"  />
