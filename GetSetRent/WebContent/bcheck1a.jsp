...
<div class="do" >
  <img class="mySlides" src="images/bd1.jpg" >
  <img class="mySlides" src="images/image2.jpg" >
  <img class="mySlides" src="images/k1.jpg" >
...
<option value="X" />X </option></select><br><br>
    Location: <select name="location"><option  value="Jharpada" />Jharpada</option></select>  <br><br>
  PPM: <select name="ppm"> <option value="Rs.18000" />Rs.18000</option></select><br><br>
