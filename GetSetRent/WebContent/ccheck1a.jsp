...
<div class="do" >
  ...
  <img class="mySlides" src="images/k6.jpg" >
...
<option value="E" />E </option></select><br><br>
    Location: <select name="location"><option  value="LinkRoad" />Link Road</option></select>  <br><br>
